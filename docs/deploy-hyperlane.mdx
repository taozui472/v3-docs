...
requiredHook:
  # The owner address is responsible for managing the hook configuration.
  owner: "0x16F4898F47c085C41d7Cc6b1dc72B91EA617dcBb"
...
Chains with devops experience, like Stride, choose to run their own relayer. While this does have some operational burden, this allows them to add new chains even faster at their pace. In addition, they can choose to set or subsidize the interchain gas costs related to relaying. See the [Operate](/docs/operate/relayer/run-relayer.mdx) docs for more information.
